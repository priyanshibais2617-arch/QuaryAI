 ...
 * Simulates cross-modal complementary fusion between optical spectral bands and SAR microwave backscatter.
 */

export async function runMockOpticalSAR(query = '', inputInfo = {}) {
  await new Promise(r => setTimeout(r, 180));

  const answer = 'The combined analysis indicates built-up areas and water-covered regions.';
